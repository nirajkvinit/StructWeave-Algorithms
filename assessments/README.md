...
|------------|-------|----------|------|---------|-----------------|
| [Entry](./entry-assessment.md) | Beginner | 12 (6+6) | 90 min | 58% | Fundamentals & basics |
| [Phase 1](./phase-1-assessment.md) | Foundation | 7 | 75 min | 71% | Two Pointers, Sliding Window, Binary Search |
| [Phase 2](./phase-2-assessment.md) | Intermediate | 7 | 85 min | 71% | Prefix Sum, Cyclic Sort, Monotonic Stack, Intervals |
| [Phase 3](./phase-3-assessment.md) | Advanced | 7 | 90 min | 71% | Heaps, K-way Merge, BFS/DFS, Topological Sort |
| [Phase 4](./phase-4-assessment.md) | Expert | 6 | 100 min | 67% | DP, Backtracking, Greedy, Divide & Conquer |
...
**Resources:**
- [Prefix Sum](../strategies/patterns/prefix-sum.md)
- [Monotonic Stack](../strategies/patterns/monotonic-stack.md)
- [Merge Intervals](../strategies/patterns/merge-intervals.md)
...
**Resources:**
- [Graph Traversal](../strategies/patterns/graph-traversal.md)
...
**Q: Can I skip assessments if I'm experienced?**
A: Start with Entry Assessment. If you score 11-12, you can move quickly through Phase 1-2, but don't skip completely. Assessments identify hidden gaps.

**Q: How many times can I retake an assessment?**
A: Unlimited, but wait at least 1 week and complete recommended practice between attempts.

**Q: What if I pass but feel unprepared?**
A: Passing is just the minimum. If you scored exactly 71%, consider more practice before advancing.

**Q: Can I use these assessments for interview prep?**
A: Yes! They're designed to match real interview difficulty and patterns.

**Q: How do these compare to real interviews?**
A: Phase 1-2: Junior/mid-level roles
Phase 3: Senior roles
Phase 4: Senior+ and competitive programming

**Q: Should I time myself strictly?**
A: Yes for realism, but understanding matters more than speed. If you need 10-20 extra minutes to finish, that's okay during learning.

**Q: What if I can't solve any problems?**
A: Go back to fundamentals. Review data structures, solve easier problems, then retry Entry Assessment.
...
**Start your journey:** [Entry Assessment](./entry-assessment.md)
